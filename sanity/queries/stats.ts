 ...
 * Trả về object với số lượng đơn hàng theo từng trạng thái
 */
export const ORDER_STATUS_DISTRIBUTION_QUERY = defineQuery(`
  {
    "total": count(*[_type == "order" && !(_id in path("drafts.**"))]),
...
/**
 * Lấy các đơn hàng chưa xử lý (đã thanh toán nhưng chưa giao hàng)
 * Loại trừ các tài liệu draft để đảm bảo số lượng chính xác
 */
